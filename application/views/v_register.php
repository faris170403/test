            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ed-com-t1-left">
                        <ul>
                            <li><a href="#">Alamat: Jl. Kubang Raya No.1447, Kubang Jaya, Kec. Siak Hulu, Kabupaten
                                    Kampar,
                                    Riau 28293</a>
                            </li>
                            <li><a href="#">No: (0761)41700</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="ed-com-t1-right">
                        <ul>
                            <li><a href="<?= base_url('login') ?>" data-toggle=" modal" data-target="#modal1">Sign
                                    In</a>
                            </li>
                            <li><a href="#!" data-toggle="modal" data-target="#modal2">Register</a></li>
                        </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="main-menu">
                        <ul>
                            ...
                            <li class="about-menu">
                                <a href="about.html" class="mm-arr">Profil</a>
                                <!-- MEGA MENU 1 -->
                                <div class="mm-pos">
                                        ...
                                        <div class="m-menu-inn">
                                            <div class="mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay menu-about" href="admission.html">
                                                        <img src="<?= base_url() ?>assets/images/gedung.jpeg" alt="">
                                                        <span>Berita</span>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="mm1-com mm1-s2">
                                                <p>Want to change the world? At Berkeley we’re doing just that. When
                                                    ...
                                                    institution
                                                    that shifts the global conversation every single day.</p>
                            ...
                            <li class="about-menu">
                                <a href="about.html" class="mm-arr">Aktifitas</a>
                                <!-- MEGA MENU 1 -->
                                <div class="mm-pos">
                                    <div class="about-mm m-menu">
                                        <div class="m-menu-inn">
                                            ...
                                            <div class="mm1-com mm1-s3">
                                                <ul>
                                                    <li><a href="all-courses.html">Kegiatan</a></li>
                                                    <li><a href="course-details.html">Course details</a></li>
                                                    <li><a href="about.html">About</a></li>
                                                    <li><a href="admission.html">Admission</a></li>
                                                    <li><a href="awards.html">Awards</a></li>
                            ...
                            <li class="cour-menu">
                                <a href="#!" class="mm-arr">Elektronik</a>
                                <!-- MEGA MENU 1 -->
                                <div class="mm-pos">
                            ...
                            <li><a href="events.html">PPBD</a>
                            </li>
                            <li><a href="dashboard.html">Alumni</a>
                            </li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item slider1 active">
                <img src="<?= base_url() ?>assets/images/slider/1.jpg" alt="">
                <div class="carousel-caption slider-con">
                    <h2>SMA Negeri Plus <span>Provinsi Riau</span></h2>
                    <p>Menumbuh kembangkan semangat dan dedikasi yang berwawasan unggulan bagi warga sekolah untuk
                        berkompetisi pada tingkat nasional dan internasional</p>
            ...
            <div class="item">
                ...
                <div class="carousel-caption slider-con">
                    <h2>SMA Negeri Plus <span>Provinsi Riau</span></h2>
                    <p>Membekali siswa untuk memiliki kecerdasan di bidang IPTEK sertapeduli pada pelestarian
                        lingkungan dan budaya melayu</p>
                </div>
            </div>
            <div class="item">
                <img src="<?= base_url() ?>assets/images/slider/3.jpg" alt="">
                <div class="carousel-caption slider-con">
                    <h2>SMA Negeri Plus <span>Provinsi Riau</span></h2>
                    <p>Membekali siswa untuk memiliki kecerdasan di bidang IPTEK sertapeduli pada pelestarian
                        lingkungan dan budaya melayu</p>
                ...
                <div class="bot-gal h-gal ho-event-mob-bot-sp">
                    ...
                    <ul>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/8.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/9.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/10.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/11.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/1.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/2.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/3.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/4.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/5.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/6.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/7.jpg" alt="">
                        </li>
                        <li><img class="materialboxed" data-caption="Education master image captions"
                                src="<?= base_url() ?>assets/images/ami/8.jpg" alt="">
                        </li>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="about.html">
                            <img src="<?= base_url() ?>assets/images/h-about.jpg" alt="">
                            <span>Academics</span>
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="admission.html">
                            <img src="<?= base_url() ?>assets/images/h-adm1.jpg" alt="">
                            <span>Admission</span>
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="dashboard.html">
                            <img src="<?= base_url() ?>assets/images/h-cam.jpg" alt="">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="research.html">
                            <img src="<?= base_url() ?>assets/images/h-res.jpg" alt="">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="all-courses.html">
                            <img src="<?= base_url() ?>assets/images/h-about1.jpg" alt="">
                            <span>Couse</span>
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="db-time-line.html">
                            <img src="<?= base_url() ?>assets/images/h-adm.jpg" alt="">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="seminar.html">
                            <img src="<?= base_url() ?>assets/images/h-cam1.jpg" alt="">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="ed-course-in">
                        <a class="course-overlay" href="events.html">
                            <img src="<?= base_url() ?>assets/images/h-res1.jpg" alt="">
                            <span>Research & Education</span>
                        </a>
                    </div>
                </div>
...
<section class="wed-hom-footer">
    <div class="container">
        <!--<div class="row">
				...
				<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don'
                                t look even slightly believable. If you are going to use a passage of Lorem Ipsum</p>
                            <p>more-or-less normal distribution of letters, as opposed to using 'Content here, content
        ...
        <div class="row wed-foot-link">
            <div class="col-md-4 foot-tc-mar-t-o">
                <h4>Top Courses</h4>
                <ul>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Accounting/Finance</a>
                    </li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">civil engineering</a>
                    </li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Art/Design</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Marine
                            Engineering</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Business
                            Management</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Journalism/Writing</a>
                    </li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Physical
                            Education</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Political Science</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-4">
                <h4>New Courses</h4>
                <ul>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Sciences</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Statistics</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Web
                            Design/Development</a>
                    </li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">SEO</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Google Business</a>
                    </li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Graphics Design</a>
                    </li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Networking
                            Courses</a></li>
                    <li><a href="<?= base_url() ?>assets/frontend/course-details.html">Information
                            technology</a>
                    </li>
                </ul>
            </div>
