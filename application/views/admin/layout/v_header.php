    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="index-2.html" class="logo"><img src="<?= base_url('assets/images/em.png') ?>" alt="" />
                </a>
            </div>
            <!--== SEARCH ==-->
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                ...
                <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'><img
                        src="<?= base_url() ?>assets/images/dancer.png" alt="" />
                    <?= $this->session->userdata('nama_user'); ?> <aria-hidden="true"></i>
                </a>
