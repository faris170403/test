        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp admin-form">
                    ...
                    <form method="post" action="<?= base_url('galeri/edit/'.$galeri->id_galeri) ?>" enctype="multipart/form-data" class=" s12">

                            <div>
                                <div class="input-field s12">
                                    <input type="text" name="nama_galeri" value="<?= $galeri->nama_galeri ?>" data-ng-model="name" class="validate" required>
                                    <label>Nama galeri</label>
                                </div>
                            </div>
                            <div>
                            <img src="<?= base_url('assets/sampul/'.$galeri->sampul)?>" width="300px">
                            ...
                            <div>
                                <div class="file-field input-field">
                                    <div class="btn admin-upload-btn">
                                        <span>File</span>
                                        <input type="file" name="sampul" class="validate" >
                                    </div>
